    ...
    <div>
      <div className='flex items-center justify-between'>
        ...
        <div>
          ...
          <p className='font-medium bg-amber-600 px-2'>Earned</p>
        </div>
      </div>
      <div className='flex p-3 mt-5 bg-gray-200 rounded-xl items-center justify-center gap-4 py-5'>
        <div className='text-center'>
          <i className="ri-time-line text-3xl font-extralight "></i>
          <h5 className='text-lg font-medium bg-amber-500 rounded-full '>10.2</h5>
