            ...
            <div className='flex justify-between items-center flex-col gap-3'>
                <div className='w-full mt-5'>
                    <div className='flex justify-start items-center gap-5 py-3 border-b-2'>
                        ...
                        <div className=''>
                            <h3 className='text-lg font-semibold'>{props.ride?.pickup?.split(',')[0]}</h3>
                    ...
                    <div className='flex justify-start items-center gap-5 py-3 border-b-2'>
                        ...
                        <div className=''>
                            <h3 className='text-lg font-semibold'>{props.ride?.destination?.split(',')[0]}</h3>
                ...
                <div className='mt-6 w-full '>
                    <form onSubmit={submitHandler}>
                        ...
                        <button 
                            className=' py-3 bg-amber-600 px-5 font-semibold flex justify-center mt-10 rounded-md'>Confirm</button>
                        <button 
                            onClick={()=>{
                                props.setconfirmridepopup(false)
                                props.setRidePopup(false)
