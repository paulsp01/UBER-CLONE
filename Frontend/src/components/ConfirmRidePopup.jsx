...
const submitHandler = (e) => {
 ...
 <div className='flex justify-between items-center border-2 border-amber-500 px-2 rounded-md'> 
   <div className='flex justify-start items-center gap-2'>
       ...
       <h2 className='font-semibold'>Swarnalee Paul</h2>
 ...
 <div className='w-full mt-5'>
   <div className='flex justify-start items-center gap-5 py-3 border-b-2'>
       ...
       <div className=''>
           <h3 className='text-lg font-semibold'>562/1-A</h3>
           <p className='text-gray-800 text-sm'>Karnataka,Amedabad,USA</p>
   ...
   <h5 className=' text-2xl'><i className="ri-square-fill"></i></h5>
       <div className=''>
           <h3 className='text-lg font-semibold'>Third Wave Cofee </h3>
           <p className='text-gray-800 text-sm'>Karnataka,Amedabad,USA</p>
 ...
 <form onSubmit={(e)=>{
  ...
  type='number' className="w-full mt-7 bg-gray-100 border-2 border-amber-300 rounded-lg font-mono px-6 py-4 text-lg mb-5" placeholder='Enter OTP' />
  
 <Link 
 to="/captain-riding"
 className=' py-3 bg-amber-600 px-5 font-semibold flex justify-center mt-10 rounded-md'>Confirm</Link>
...
<button 
 ...
 className=' py-3 bg-gray-300 px-5  font-semibold w-full mt-5 rounded-md'>Cancel</button>
