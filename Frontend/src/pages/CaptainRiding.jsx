...
const CaptainRiding = (props) => {
    ...
    //const { CaptainDataContext } = useContext(CaptainDataContext)
    ...
    //console.log("Captain from API:", captain);

    // If ride doesn't have captain details, add them
            ...
            <div 
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <h5 className='font-medium capitalize'>{rideData?.captain?.fullname?.firstname }</h5>
                    </div>
                </div>
                <h5 
                    onClick={()=>{
