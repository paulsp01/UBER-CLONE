  ...
  return (
    ...
    <div className='fixed p-5 top-0 flex items-center justify-between w-full'>
     ...
     <h5 
        ...
        <h4 className='text-xl font-medium'>4 KM Away---------------------<span className='text-sm font-semibold'>Click here</span></h4>
