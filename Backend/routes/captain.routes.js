...
router.post('/register', [
    ...
    body('vehicle.vehicletype').notEmpty().withMessage('Vehicle type is required').isIn(['Car', 'Motorcycle', 'Auto']).withMessage('Invalid vehicle type'), // Corrected field name and values
